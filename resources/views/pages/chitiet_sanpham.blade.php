						...
						<div class="col-sm-8">
							<div class="single-item-body">
								...
								<p class="single-item-price">
									...
									<span class="flash-sale">{{ number_format($sanpham->unit_price, 0) }} VNĐ</span>
									@else
										<span class="flash-del">{{ number_format($sanpham->unit_price, 0) }} VNĐ</span>
										<span class="flash-sale">{{ number_format($sanpham->promotion_price, 0) }} VNĐ</span>
									@endif
								</p>
							</div>
							...
							<div class="single-item-options">
								<label style="font-size: 15px;padding: 5px;">Số lượng:</label>
